defmodule StickyNotesApp.Notes do
  @moduledoc """
  The Notes context.
  """
  ...
  # Gets a column based on the supplied username
  def get_column_by_username(username) do
      Repo.get_by(Column, username: username)
  end
